...
python3 bin/tsv2json.py "data/cnotes_zh_en_dict.tsv" $OUTPUT_DIR/cnotes_zh_en_dict.json "Chinese Notes dictionary" "Chinese Notes" "Alex Amies" "Creative Commons Attribution-Share Alike 3.0"
