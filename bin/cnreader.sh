...
mkdir $WEB_DIR/analysis/sunzibingfa
mkdir $WEB_DIR/analysis/taixuanjing
mkdir $WEB_DIR/analysis/taoyuanmingji
...
mkdir $WEB_DIR/analysis/xinshu
mkdir $WEB_DIR/analysis/xinyu
...
mkdir $WEB_DIR/analysis/yuejueshu
...
mkdir $WEB_DIR/sunzibingfa
mkdir $WEB_DIR/taixuanjing
mkdir $WEB_DIR/taoyuanmingji
