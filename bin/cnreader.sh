...
python3 bin/words2json.py "data/words.txt,data/translation_memory_literary.txt,data/translation_memory_literary.txt,data/modern_named_entities.txt" $WEB_DIR/dist/ntireader.json
