...
python3 bin/tsv2json.py "data/translation_memory_literary.txt" $OUTPUT_DIR/translation_memory_literary.json "Chinese Notes literary Chinese quotations" "Quotations" "Alex Amies" "Creative Commons Attribution-Share Alike 3.0"
